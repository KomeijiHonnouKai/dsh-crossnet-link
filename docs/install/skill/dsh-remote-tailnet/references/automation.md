...
> 最后更新:2026-09-26(t4 集成同步:§1 表的 `security.md §6.2` 收为 `§6`——整行覆盖语义在 §6.1、裸 entry 在 §6.2;§4.1 的跳转补上 `browser-control.md` 小节号)。上一版:2026-09-24 17:04(本机 DSH 会话,W4)。本次使用的命令见 `README.md` 的「本次修订」。
