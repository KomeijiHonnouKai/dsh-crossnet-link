/*
 * dsh-crossnet-link - CLIENT half of the persistent DSH plugin - BROWSER BUNDLE.
 ...
 */
window.__ModuleLoader__.load({ id: "dsh-crossnet-link", factory: (require) => {
...
// ==== SHARED BODY END ====
exports.name = "dsh-crossnet-link";
