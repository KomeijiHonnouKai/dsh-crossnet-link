<#
  run-tests.ps1 - cross-environment and fault-injection test suite for the
                 dsh-crossnet-link collector shipped by this repository.
  ...
  COMMANDS USED (read-only; the suite creates temp dirs under %TEMP% and removes them):
    ...
    powershell -NoProfile -ExecutionPolicy Bypass -File dsh-crossnet-link/tests/run-tests.ps1 -List
    powershell -NoProfile -ExecutionPolicy Bypass -File dsh-crossnet-link/tests/run-tests.ps1 -Filter locale
    powershell -NoProfile -ExecutionPolicy Bypass -File dsh-crossnet-link/tests/run-tests.ps1 -Only isolation
    powershell -NoProfile -ExecutionPolicy Bypass -File dsh-crossnet-link/tests/run-tests.ps1 -KeepTemp -Verbose
...
if ($List) {
  Write-Output '# generated by: powershell -NoProfile -ExecutionPolicy Bypass -File dsh-crossnet-link/tests/run-tests.ps1 -List'
  Write-Output ''
